 ...
 */
const SITE_CONFIG = {
  whatsappNumber: '5511999999999' // TODO: colocar o número real aqui
};
...
const SITE_DATA = {
  ...
  problemStats: [
    { value: 9, suffix: '+', unit: 'h/dia', label: 'tempo médio de tela entre adolescentes' },
  ...
  resultStats: [
    ...
    { value: 65, suffix: '%', label: 'aumentaram a prática de atividade física' }
  ],

  testimonials: [
    {
      quote: 'O Conecta Vida me ajudou a perceber quanto tempo eu perdia no celular. Os desafios são divertidos e me motivaram a sair mais de casa e me concentrar nos estudos.',
      name: 'Estudante',
      role: '16 anos'
    },
    {
      quote: 'Notei uma melhora significativa na atenção dos alunos em sala de aula depois que adotamos os desafios do Conecta Vida. A ferramenta é inovadora e muito bem recebida pela turma.',
      name: 'Professora',
      role: 'Ensino Médio'
    }
  ],
